...
def test_chat_deepseek_native_uses_adaptive_thinking():
    """Native DeepSeek v4 uses the adaptive thinking dialect."""
    settings = _make_settings()
...
def test_sensenova_deepseek_uses_gateway_thinking_dialect():
    settings = _make_settings()
    settings.base_url = "https://token.sensenova.cn/v1"
...
def test_sensenova_thinking_disabled_uses_disabled_enum_without_effort():
    settings = _make_settings()
    settings.base_url = "https://token.sensenova.cn/v1"
    settings.model = "deepseek-v4-flash"
...
def test_sensenova_stream_uses_the_same_disabled_gateway_dialect():
    settings = _make_settings()
    settings.base_url = "https://token.sensenova.cn/v1"
    settings.model = "deepseek-v4-flash"
    settings.thinking = False
...
def test_completion_max_tokens_uses_url_bound_override():
    settings = _make_settings()
    settings.base_url = "https://proxy.example.com/v1/"
    settings.max_tokens_by_base_url = {"https://proxy.example.com/v1": 393_216}
    assert _completion_max_tokens(settings, extra_body={}, effort="max") == 393_216


def test_chat_sends_url_bound_max_tokens_override():
    settings = _make_settings()
    settings.base_url = "https://proxy.example.com/v1/"
    settings.model = "deepseek-v4-pro"
    settings.thinking = False
