...
def _render_chart(bars_newest_first: list[Any], ema20_newest_first: list[float],
    ...
    for i, bar in enumerate(bars):
        ...
        is_bull = c >= o
        color = "#00D084" if is_bull else "#FF4757"
    ...
    _TP_COLOR    = "#00D084"   # green
    _TP2_COLOR   = "#00D084"   # green
    _SL_COLOR    = "#FF4757"   # red
    ...
    if entry_price is not None or n > 0:
        ...
        if _is_long:
            ...
            ax.annotate(
                ...
                arrowprops=dict(arrowstyle="-|>", color="#00D084",
                                lw=2.5, mutation_scale=18),
                zorder=8,
            )
            ax.text(
                _arrow_x, _tail_y - _price_range * 0.005, "做多",
                color="#00D084", fontsize=8, ha="center", va="top",
            ...
            ax.text(
                ...
                color="#FF4757", fontsize=8, ha="center", va="bottom",
                fontweight="bold", zorder=9,
            )
