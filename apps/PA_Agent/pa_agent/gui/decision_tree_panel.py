...
def _apply_dark_data_palette(widget: QTableWidget | QTreeWidget) -> None:
    ...
    pal.setColor(QPalette.ColorRole.Highlight, QColor("#4A7EBB"))
...
class DecisionTreePanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._terminal_banner.setStyleSheet(
            f"font-size: 15px; font-weight: bold; padding: 10px;"
        ...
        self._path_table.setShowGrid(True)
        self._path_table.setGridStyle(Qt.PenStyle.SolidLine)
        self._path_table.setStyleSheet(
            "QTableWidget#pathReplayTable { gridline-color: #333A45; font-size: 14px; }"
            "QTableWidget#pathReplayTable QHeaderView::section {"
        ...
        self._tree.setStyleSheet(
            "QTreeWidget#decisionTreeView { font-size: 14px; }"
            "QTreeWidget#decisionTreeView::item {"
            " border-right: 1px solid #333A45;"
            "}"
            "QTreeWidget#decisionTreeView QHeaderView::section {"
            " border-right: 1px solid #333A45;"
            "}"
        )
